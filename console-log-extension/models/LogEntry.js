 ...
 */
class LogEntry {
  constructor(level, message, args, url, tabId, source = 'page') {
    ...
    // Source of the log: 'page' | 'extension' | others
    this.source = source || 'page';
    // Mark if this is likely generated by the extension
    this.isExtension = this.source === 'extension' || (typeof this.url === 'string' && this.url.startsWith('chrome-extension://'));
  }
